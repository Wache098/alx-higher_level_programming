...
class Square:
    ...
    def __init__(self, size=0, position=(0, 0)):
        ...
        Args:
            ...
            position (tuple, optional): The pos. Defaults to (0, 0).

        Raises:
            TypeError: If size is not an int or pos is not a tuple of 2 + ints
            ValueError: If size is less than 0 or pos contains - values.
